...
<title>Online Medical System Webpage</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Online Medical System</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Buy Medicines and Others</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="buy.html">buy</a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Online Medical Shop</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Health care-
				Personal Development - medicine - Exersice</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Buy Medicines and Others</h2>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">A web-based pharmacy is an online system that provides 
					a platform for customers to purchase medicinal drugs and E-services online, 
					allowing the customer to receive medicines/services in the comfort of their homes 
					within a short time.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Medicine is the science and practice of caring for a patient,
					 managing the diagnosis, prognosis, prevention,treatment, palliation of their injury
					  or disease, and promoting their health!</p>
				</div>
			</div>
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					...
					class="fas fa-download me-2"></i>Simple Treatnment Method Free Download!
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form method="post" action="h_register" id="contactForm" data-sb-form-api-token="API_TOKEN">
						<!-- Name input-->
						...
						<!-- Phone number input-->
						<div class="form-floating mb-3">
							<input name ="usernumber" class="form-control" id="phone" type="tel"
						...
						<!-- Message input-->
						<div class="form-floating mb-3">
							<textarea name ="useraddress"  class="form-control" id="message" type="text"
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About medicines</h4>
					<p class="lead mb-0">
						Open Your online Store in the Medical Field <a href="http://startbootstrap.com">Treatnments</a> .
					</p>
				</div>
			</div>
		</div>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw" class="btn-close" type="button" data-bs-dismiss="modal"
						aria-label="Close">Close Window</i> 
								</button>
							</div>
						</div>
					</div>
